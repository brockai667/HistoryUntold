#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""PRO engine pre NextByte reels (tech dizajn, elektricka modra) (facts dizajn: subjektovo-presny stock, chipy so sync-om, bez mapy) (overeny na Plitvice demu, schvaleny 2026-07-04).
...
UA = {"User-Agent": "NextByte/1.0 (tech news channel)"}
...
def render_overlay_seq(sc, idx, work):
    ...
    if role == "hook":
        ...
        chips[0] = {"img": chip_png("@NextByte", 58, "accent"), "at": 0.35}
...
# ---------------------------------------------------------------- render scen
GRADE = "eq=contrast=1.09:saturation=1.13:brightness=0.02,vignette=angle=PI/5,noise=alls=4:allf=t"
